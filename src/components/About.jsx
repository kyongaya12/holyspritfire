...
{/* 
            ...
            <div className="container">
               ...
               <h1>에드 시츠로넬리 목사님의 성령사역 </h1>
              <div className="col-md-12 float-md-end mb-3 ms-md-3" />
                <p>에드 시츠로넬리 목사님의 사역은 세계 끝까지 그를 이끄는 성령의 힘에 의해 이루어진 예언,치유, 축사로 복음을 전파하는 데에 초점을 맞추고 있습니다.</p>
...
<p>바쁜 국제 일정 외에도, 에드 시츠로넬리 목사님은 뉴욕과 텍사스에 다문화적인 교회들을 지휘하고 있습니다. 교회 구성원으로는 21개국 이상의 국가들이 참여하고 있습니다. 또한, 에콰도르, 가나, 파키스탄 등 세계 여러 지점에 다른 지점들도 있습니다. </p>
                        ...
                        <div className="container"  >
                            <div className="row ">
                               ...
                               <div className="what-we-believe">
                                <h2>우리의 사명</h2>
<p>에드 시츠로넬리 사역은 하나님의 뜻에 의해 존재하여 이 세대와 차세대에 영향을 끼치고, 모든 민족에 복음의 능력을 가져가서 사람들을 구원하고 치유하며 해방시키며 종합적인 복지를 주는 데 목적이 있습니다(3요한서 2장).
...
<p>에드 시츠로넬리 사역의 비전은 예수 그리스도의 속죄의 혜택과 특권에 대한 지식으로 교회를 갖추는 것입니다. 이는 지구상에서의 성공적인 삶과 그 이후 천국에서의 필요한 것으로, 성령의 변형력과 교제의 진리를 가르치는 것을 포함합니다. 가능한 모든 의사소통 채널을 활용하여 예수 그리스도의 놀라운 치유 능력을 모든 민족에 전하고, 교회가 성령의 사람을 알고 인정하고 의지하는 데 도움을 주는 것입니다. 하나님의 영광이 세상에서 가장 어두운 곳에까지 이르러 사람들과 정부들에게 확실한 변화를 가져다주길 바랍니다.</p>
...
<div className="what-we-believe">
 <h1>성경의 권위에 기초</h1>              
 <p>에드 목사님의 사역 에서는 성경의 권위에 기초하여 신앙을 구축하며 그것이 하나님의 불가능한 말씀임을 믿습니다.</p> 
