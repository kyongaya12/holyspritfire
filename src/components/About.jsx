                        ...
                        <div className="container"  >
                            <div className="row ">
                               ...
                               <div className="what-we-believe">
                                <h2>우리의 사명</h2>
<p>에드 시트론넬리 사역은 하나님의 뜻에 의해 존재하여 이 세대와 차세대에 영향을 끼치고, 
모든 민족에 복음의 능력을 가져가서 사람들을 구원하고 치유하며 해방시키며 종합적인 복지를 주는 데 목적이 있습니다(3요한서 2장). 
<p>이는 주님께서 주신 대사를 수행하는 것입니다(마태복음 28:18-20; 마가복음 16:15-18). </p>
...
에드 시트론넬리 사역의 비전은 예수 그리스도의 속죄의 혜택과 특권에 대한 지식으로 교회를 갖추는 것입니다. 이는 지구상에서의 성공적인 삶과 그 이후 천국에서의 필요한 것으로, 성령의 변형력과 교제의 진리를 가르치는 것을 포함합니다. 가능한 모든 의사소통 채널을 활용하여 예수 그리스도의 놀라운 치유 능력을 모든 민족에 전하고, 교회가 성령의 사람을 알고 인정하고 의지하는 데 도움을 주는 것입니다. 하나님의 영광이 세상에서 가장 어두운 곳에까지 이르러 사람들과 정부들에게 확실한 변화를 가져다주길 바랍니다.</p>
<hr/>          
...
<p>우리는 마귀들을 쫓아내는 해방 사역과 마가복음 16:15-18에 따라 병자를 위해 기도하여 신으로부터의 치유를 믿습니다.</p>
