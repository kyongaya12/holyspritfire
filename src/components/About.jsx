...
{/* 
            ...
            <div className="container">
               ...
               <h1>선지자 에드 시츠로넬리 성령사역 </h1>
              <div className="col-md-12" />
                <p>선지자 에드님의 사역은 세계 끝까지 그를 이끄는 성령의 힘에 의해 이루어진 예언,치유, 축사로 복음을 전파하는 데에 초점을 맞추고 있습니다.</p>
                ...
                <p>선지자 에드님은 기적의 표적들이 그의 사역을 따르며 10 만명에 달하는 대규모 기적의 크루세이드를 진행하여 다양한 나라들을 하나님의 나라로 표식을 남기고 있습니다. </p>
...
<p>바쁜 국제 일정 외에도, 선지자 에드님은 뉴욕과 텍사스에 다문화적인 교회들을 지휘하고 있습니다. 교회 구성원으로는 21개국 이상의 국가들이 참여하고 있습니다. 또한, 에콰도르, 가나, 파키스탄 등 세계 여러 지점에 다른 지점들도 있습니다. </p>
...
<p>선지자 에드 목사님은 아내 캐롤과 35년 이상 함께하며 결혼 생활을 영위하고 있으며, 그들은 절개하는 하나님을 경외하는 아름다운 세 자녀, 저스틴, 가브리엘, 한나를 두고 있습니다. 그는 자주 기적 크루세이드에서 사람들에게 말씀할 때 "우리의 가장 친한 친구인 성령께 감사와 찬양을 보내 주세요. 그분께서 우리와 함께 계시고 행하신 일들을 인정해 주세요"라고 말합니다.
                        ...
                        <div className="container"  >
                            <div className="row ">
                               ...
                               <div className="what-we-believe">
                                <h2>우리의 사명</h2>
<p>선지자 에드님 사역은 하나님의 뜻에 의해 존재하여 이 세대와 차세대에 영향을 끼치고, 모든 민족에 복음의 능력을 가져가서 사람들을 구원하고 치유하며 해방시키며 종합적인 복지를 주는 데 목적이 있습니다(3요한서 2장).
...
<p>선지자 에드님 사역의 비전은 예수 그리스도의 속죄의 혜택과 특권에 대한 지식으로 교회를 갖추는 것입니다. 이는 지구상에서의 성공적인 삶과 그 이후 천국에서의 필요한 것으로, 성령의 변형력과 교제의 진리를 가르치는 것을 포함합니다. 가능한 모든 의사소통 채널을 활용하여 예수 그리스도의 놀라운 치유 능력을 모든 민족에 전하고, 교회가 성령의 사람을 알고 인정하고 의지하는 데 도움을 주는 것입니다. 하나님의 영광이 세상에서 가장 어두운 곳에까지 이르러 사람들과 정부들에게 확실한 변화를 가져다주길 바랍니다.</p>
...
<div className="what-we-believe">
 <h1>성경의 권위에 기초</h1>              
 <p>선지자 에드님의 사역 에서는 성경의 권위에 기초하여 신앙을 구축하며 그것이 하나님의 불가능한 말씀임을 믿습니다.</p> 
 <p>우리는 모든 면에서 생활의 각 영역에서 성경적 기준을 유지하려고 노력합니다.</p>   
 <ul className="list-style">
 <li>아버지, 아들, 성령으로 이루어진 삼위일체.</li>
 <li>유일하신 하나님의 아들 예수 그리스도, 성령으로 잉태되어 처녀 마리아에게서 나시고 십자가에 못 박혀 죽으셨으며 장사되었습니다. 예수 그리스도는 부활하여 하늘로 올라가 하나님 아버지 우편에 앉아 계시며 참 하나님과 참 인간입니다.</li>        
<li>주 예수님의 공중에서 교회를 하늘로 데려가는 재림.</li>
<li>영원한 생명인 천국 또는 지옥은 개인적으로 예수님을 주님으로 믿는 마음과 입으로 시인하느냐의 조건으로 주어집니다.</li>
<li>구원 후의 물 세례는 그리스도와 함께 잠들고 새 생명으로 걸어가기 위한 증거로 행해집니다.</li>
<li>방언으로 말하는 증거와 함께 성령의 세례</li>
<li>우리는 마귀들을 쫓아내는 해방 사역과 마가복음 16:15-18에 따라 병자를 위해 기도하여  하나님으로부터의 치유를 믿습니다.</li>
</ul>

  
<blockquote class="blockquote">
<p>믿는 자들에게는 이런 표적이 따르리니 곧 저희가 내 이름으로 귀신을 쫓아내며 새 방언을 말하며 뱀을 집으며 무슨 독을 마실찌라도 해를 받지 아니하며 병든 사람에게 손을 얹은즉 나으리라 하시더라</p>
<footer class="blockquote-footer">마가복음 16:17-18 KRV</footer>
</blockquote>
</div>
</div>
