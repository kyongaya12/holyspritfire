...
<p>제가 당신을 에드 씬트로넬리 사역장에 초대하고 싶습니다. 만일 여러분이 에드 씬트로넬리 사역에 관심이 있어시면, 연락하시길 바랍니다.</p>  */}
     ...
     <div className="container vk-bg-container" >
                ...
                <div className="row p4-4 ">
                    <div className="col-md-12 py-4">
                        <h1 className="text-primary fw-bold mb-4 text-center vk-title1"> 5중(사도, 선지자, 전도자, 목사,선생님) 사역 교회 </h1>
...
<p>이 교회는 성령님의 인도아래, 씨니어 예언자이신 에드 씬트로넬리께서 지휘 하시고 지금 텍사스에 사역하시고, 그의 영적 아들, 쥬이어 예언자이신 조지 땡찬은 뉴욕에서 사역 하시는 분입니다.</p>
<p> 선지자 에드님은   성령님의 인도 하심에 따라 미국 여러곳을 집회 
